 ...
 *  $Id: mbr_swplssxp.c 2261 2016-01-07 01:49:22Z caress $
 *
...
static char rcs_id[] = "$Id: mbr_swplssxp.c 2261 2016-01-07 01:49:22Z caress $";
...
int mbr_info_swplssxp(
	...
	int *traveltime, int *beam_flagging, int *platform_source,
	int *nav_source, int *heading_source,
